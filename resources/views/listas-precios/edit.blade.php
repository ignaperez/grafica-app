...
<div class="gcard mb-4" style="max-width:580px">
    <div class="gcard-hd">
        <span class="gcard-title">{{ $listaPrecio->nombre }}</span>
    </div>
    <div class="gcard-bd">
        <form action="{{ route('listas-precios.update', $listaPrecio->id) }}" method="POST">
            ...
            <div class="gfg">
                ...
                <textarea name="descripcion" class="gtextarea" rows="2">{{ old('descripcion', $listaPrecio->descripcion) }}</textarea>
            </div>
            ...
            <div class="txd" style="font-size:12px;margin-bottom:12px">
                ...
                Completá para pisar con un valor distinto solo para esta lista. Dejá en blanco para usar el global.
            </div>
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px">
                ...
                <div class="gfg">
                    ...
                    <input type="number" name="mo_unidad" step="0.01" min="0"
                           ...
                           value="{{ old('mo_unidad', $listaPrecio->mo_unidad) }}">
                </div>
            </div>

            @if($listaPrecio->mo_m2 !== null || $listaPrecio->mo_ml !== null || $listaPrecio->mo_unidad !== null)
            <div style="margin-top:8px;font-size:12px;color:#4caf50">
                ● Esta lista tiene MO personalizada
                (m²: ${{ number_format($listaPrecio->mo_m2 ?? $moGlobal['m2'], 2) }})
            </div>
            @endif
