...
<div style="display:flex;gap:8px;align-items:center">
    <span style="font-size:11px;background:#1c1400;border:1px solid #3a2800;color:#c8a040;
                 padding:4px 12px;border-radius:20px;letter-spacing:.5px">
        ● PREVIEW
    </span>
    <a href="{{ route('dashboard') }}" class="gbtn gbtn-ghost gbtn-sm">← Actual</a>
    <a href="{{ route('dashboard.apply-preview') }}" class="gbtn gbtn-primary gbtn-sm"
       onclick="return confirm('¿Aplicar este diseño?')">Aplicar diseño</a>
</div>
@endsection
